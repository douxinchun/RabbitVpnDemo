...
//        if (packetFlow == nil) {
//            NSLog("tuninterface packetflow init is nil")
//        } else {
//            NSLog("tuninterface packetflow init not nil")
//        }
    ...
    open func start() {
        QueueFactory.executeOnQueueSynchronizedly {
            if (self.packetFlow != nil) {
                NSLog("tuninterface packetflow not nil")
            } else {
                NSLog("tuninterface packetflow is nil")
            }
        ...
        packetFlow?.readPackets { packets, versions in
            QueueFactory.getQueue().async {
                for (i, packet) in packets.enumerated() {
                    NSLog("tuninterface read packet")
